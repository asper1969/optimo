...
var _catalogView = __webpack_require__(12);
...
var compare = {
    ...
    checkCompareList: function checkCompareList() {
        ...
        this.settings.listItem.each(function () {
            ...
            $('.node-product-display a[href="' + item + '"]').closest('.node-product-display').addClass('in-compare-list').find('.compare input[type="submit"]').attr('value', 'Перейти к сравнению');
        });
    }
};
...
var catalogView = {
    ...
    settings: {
        ...
        productText: $('.view-products-catalog.view-display-id-default ' + '.node-product-display.node-teaser .text')
    },
