...
var _openPopup = __webpack_require__(6);
...
var _compareTable = __webpack_require__(11);

var _compareTable2 = _interopRequireDefault(_compareTable);
...
(function ($) {
   ...
   $(document).ready(function () {
      ...
      if ($('#properties-compare-table').length) {
         _compareTable2.default.init();
      }

      if ($('.view-products-catalog.view-display-id-default ').length) {
         $('.view-products-catalog.view-display-id-default ' + '.node-product-display.node-teaser .text').matchHeight();
      }
      ...
      $('.region-new .view-content, ' + '.region-hits .view-content, .region-recommendations .view-content').slick({
         slidesToShow: 5,
         variableWidth: true,
         dots: false,
         arrows: true
      ...
      $('.fieldset-wrapper .webform-component--fieldset--ya-soglasen-s-usloviyami-podpiski ' + 'input').click(function () {
         var $checkbox = $(this);
...
var mobileMenu = {
    ...
    catalogOpen: function catalogOpen() {
        this.settings.catalog.addClass('is-active');
        this.settings.overlay.addClass('is-active');
        this.settings.body.addClass('is-fixed');
    },

    catalogClose: function catalogClose() {
...
var cart = {
    ...
    init: function init() {
        var minus = '<div class="btn btn__minus noselect">-</div>';
        var plus = '<div class="btn btn__plus noselect">+</div>';
        var $handler = this;
    ...
    saveVal: function saveVal($this) {
        var val = parseInt($this.val());
        $this.val('');
        this.settings.val = val;
    },

    setVal: function setVal($this) {
        $this.val(this.settings.val);
    },

    checkInput: function checkInput(val, $this) {
    ...
    calcVal: function calcVal($this) {
        var val = this.settings.val;
    ...
    setShipping: function setShipping($shippingType) {
        this.settings.shippings.removeClass('is-active');
        this.settings.shippingTypeActive.closest('.form-item').addClass('is-active');
        var $inPerson = $('#edit-commerce-payment-payment-method-in-personcommerce-payment-in-person');
    ...
    setPayment: function setPayment() {
        ...
        this.settings.paymentTypeActive.closest('.form-item').removeClass('is-muted').addClass('is-active').find('input').click();
    }
};
...
var compare = {
    ...
    init: function init() {
        ...
        this.settings.compareBtn.on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function success(response) {
                    $form.closest('.compare').append('<a href="/properties/compare" class="btn btn_to_compare">Перейти к сравнению</a>').closest('.node-product-display').addClass('in-compare-list').find('form').remove();
                }
            });
        ...
        this.settings.compareBtnWrapper.on('click', function (e) {
            ...
            if ($this.closest('.node-product-display').hasClass('in-compare-list')) {
                ...
                var item = $this.closest('.node-product-display').find('.group__content a').attr('href');
                $('.node-product-display a[href="' + item + '"]').closest('.node-product-display').addClass('in-compare-list');
    ...
    checkCompareList: function checkCompareList() {
...
var compareTable = {
    ...
    init: function init() {
        var $handler = this;
        var $activeCategory = this.settings.categoryActive;
        var tid = $activeCategory.attr('data-tid');
    ...
    setActive: function setActive(tid) {
